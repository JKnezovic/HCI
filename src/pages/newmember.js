...
export default ({
  ...
  <input type="text"
             id="firstname"
             className="ControlInput ControlInput--firstname"
             placeholder=" "
             required
      />
  <label htmlFor="firstname"
          className="Control-label Control-label--firstname"
  >First Name</label>
    <input type="text"
          id="surname"
          className="ControlInput ControlInput--surname"
          placeholder=" "
          required
  />
<label htmlFor="surname"
        className="Control-label Control-label--surname"
>Last name</label>
<input type="email"
        id="email"
...
/>
      ...
      <div className="Control-requirements Control-requirements--email">
        ...
        <div className="Control-requirements">
          Must contain at least 6 characters. Try to combine numbers, letters and signs.
        </div>
        ...
        <p style={{alignSelf:'center',paddingTop:'8px'}}>Already have an account? <Link to="/signin">Login now!</Link></p>
  </div>
